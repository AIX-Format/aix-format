...
export interface AIXFormat {
  ...
  /**
   * Unified BOM (SaaS-BOM, AI-BOM, Infra-BOM) for regulatory compliance and EU AI Act.
   */
  unified_bom?: {
    /**
     * References to SaaS dependencies.
     */
    saas_refs?: string[];
    /**
     * References to AI/ML models, datasets, or providers.
     */
    ai_refs?: string[];
    /**
     * References to Cloud resources and infrastructure.
     */
    infra_refs?: string[];
    /**
     * Identified risk profiles and threat mitigations.
     */
    risk_refs?: string[];
    /**
     * Target compliance frameworks (e.g., EU_AI_ACT, SOC2_TYPE_2).
     */
    compliance_profiles?: string[];
    /**
     * URLs or pointers to generated compliance export bundles.
     */
