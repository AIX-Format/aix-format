...
export const AgenticKycSetup = memo(function AgenticKycSetup() {
  ...
  // FIX: use refs to store timer IDs so we can properly clean them up.
  // The previous implementation's `return () => clearTimeout(t2)` inside a
  // setTimeout callback was a no-op — it returned the cleanup to nobody.
