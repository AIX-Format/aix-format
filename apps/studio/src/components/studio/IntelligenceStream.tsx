...
export function IntelligenceStream() {
  ...
  return (
    <div className="glass-panel-heavy rounded-2xl p-5 h-[350px] flex flex-col gap-4 overflow-hidden border border-white/10 shadow-2xl relative">
      {/* Decorative corners */}
        ...
        <AnimatePresence mode="popLayout">
          {events.map((event, i) => (
            <motion.div
              ...
              className="group flex items-start gap-3 p-2.5 rounded-lg bg-white/[0.03] border border-white/[0.05] hover:bg-white/[0.06] hover:border-cyan-500/30 transition-all duration-300 cursor-default"
            >
